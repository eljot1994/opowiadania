document.addEventListener('DOMContentLoaded', () => {
    ...
    showHtmlBtn.addEventListener('click', () => {
        ...
        // Wypełnij kontener kodu, zamieniając znaki specjalne na encje HTML
    ...
    function escapeRegExp(string) { /* ... (bez zmian) */ }
    function formatBreaksToParagraphs(htmlContent) { /* ... (bez zmian) */ }
    replaceBtn.addEventListener('click', () => { /* ... (bez zmian) */ });
    replaceAllBtn.addEventListener('click', () => { /* ... (bez zmian) */ });
    ...
    // Skopiowałem tylko kluczowe fragmenty, cała reszta funkcji pozostaje taka sama
    // jak w poprzedniej odpowiedzi, więc wklejam ją poniżej w całości dla pewności.
});

// Poniżej pełny kod admin.js do skopiowania:
document.addEventListener('DOMContentLoaded', () => {
